...
2. Place the uncompresed folder in the root of the project, and modify the cell of the ```Tennis.ipynb``` ```env = UnityEnvironment(file_name="<Path/to/executable>")``` inserting the path of the executable. 
